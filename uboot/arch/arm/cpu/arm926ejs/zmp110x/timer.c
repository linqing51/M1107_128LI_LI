...
#define ZMP_TIMER_CTRL1		TIMER1_CTRL1_REG
#define ZMP_TIMER_CTRL2		TIMER1_CTRL2_REG
...
int timer_init(void)
{
	...
	writel(timecnt, ZMP_TIMER_CTRL1);
	writel(regval, ZMP_TIMER_CTRL2);
	return 0;
}
...
void reset_timer_masked(void)
{
	...
	regval = readl(ZMP_TIMER_CTRL2);
	writel(regval | TIMER_READ_SEL_BIT, ZMP_TIMER_CTRL2);

	/* reset time */
	regval = readl(ZMP_TIMER_CTRL1);
...
unsigned long long get_ticks(void)
{
	...
	regval = __raw_readl(ZMP_TIMER_CTRL2);
	__raw_writel(regval | TIMER_READ_SEL_BIT, ZMP_TIMER_CTRL2);

	now = __raw_readl(ZMP_TIMER_CTRL1);
