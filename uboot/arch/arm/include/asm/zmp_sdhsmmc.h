...
#ifndef ZMP_SDHSMMC_H_
#define ZMP_SDHSMMC_H_

enum zmp_mmc_cd_mode
{
    CD_CLK_MODE = 1,            
    DETECT_GPIO_MODE = 2,
    NON_REMOVABLE_MODE = 3
};

struct mmc_cd_info{
	enum zmp_mmc_cd_mode mmc_plug_mod;
	unsigned int mmc_plug_gpio_index;
};
