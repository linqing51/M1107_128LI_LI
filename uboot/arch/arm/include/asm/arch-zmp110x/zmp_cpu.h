 ...
 */
#define ZMP_CPU_Mode_USR                              0x10
#define ZMP_CPU_Mode_FIQ                              0x11
#define ZMP_CPU_Mode_IRQ                              0x12
#define ZMP_CPU_Mode_SVC                              0x13
#define ZMP_CPU_Mode_ABT                              0x17
#define ZMP_CPU_Mode_UNDEF                            0x1B
#define ZMP_CPU_Mode_SYS                              0x1F            
#define ZMP_CPU_I_Bit                                 0x80
#define ZMP_CPU_F_Bit                                 0x40
/** @} */
...
#define IRQINT_MASK_REG                                 (CHIP_CONF_BASE_ADDR + 0x00000024)      // module IRQ interrupt mask register, 1: mask; 0:unmask(default);
#define FRQINT_MASK_REG                                 (CHIP_CONF_BASE_ADDR + 0x00000028)      // module FRQ interrupt mask register, 1: mask; 0:unmask(default);
#define INT_STATUS_REG                                  (CHIP_CONF_BASE_ADDR + 0x0000004C)      // module interrupt status register
#define INT_SYS_MODULE_REG                              (CHIP_CONF_BASE_ADDR + 0x00000030)      // system module interrupt status control register
