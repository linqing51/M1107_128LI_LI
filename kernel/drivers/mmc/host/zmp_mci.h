 ...
 */
#ifndef __ZMP_MCI_H__
#define __ZMP_MCI_H__

#define SDIO_INTRCTR_REG		0x000
#define SDIO_INTR_CHECK_ENABLE	(1 << 8)
/* H3B/H3D using auto detect sdio irq*/
...
#define MCI_PLUGINOFF_REG0		 	(ZMP_VA_SYSCTRL + 0x80)   //0x0800,0080
#define MCI_PLUGINOFF_REG1		 	(ZMP_VA_SYSCTRL + 0x84)   //0x0800,0084
