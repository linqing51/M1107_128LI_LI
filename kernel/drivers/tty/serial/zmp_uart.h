...
#ifndef __ZMP_UART_H_
#define __ZMP_UART_H_
...
#define NR_PORTS		4
#define ZMP_SERIAL_NAME	"ttyZMP"

#define ZMP_UART0_TXBUF_BASE	(ZMP_VA_L2MEM + 0x1000)
#define ZMP_UART0_RXBUF_BASE	(ZMP_VA_L2MEM + 0x1080)

#define ZMP_UART1_TXBUF_BASE	(ZMP_VA_L2MEM + 0x1100)
#define ZMP_UART1_RXBUF_BASE	(ZMP_VA_L2MEM + 0x1180)

#define ZMP_UART2_TXBUF_BASE	(ZMP_VA_L2MEM + 0x1200)
#define ZMP_UART2_RXBUF_BASE	(ZMP_VA_L2MEM + 0x1280)

#define ZMP_UART3_TXBUF_BASE	(ZMP_VA_L2MEM + 0x1300)
#define ZMP_UART3_RXBUF_BASE	(ZMP_VA_L2MEM + 0x1380)
#define ZMP_UART_REG_OFFSET  0x100

#define ZMP_UART0_BASE			(ZMP_VA_UART + 0x0000)
#define ZMP_UART1_BASE			(ZMP_VA_UART + 0x8000)

#define ZMP_UART0_PA_BASE		(ZMP_PA_UART + 0x0000)
#define ZMP_UART1_PA_BASE		(ZMP_PA_UART + 0x8000)
...
#define DISABLE		    	(0)
#define ENABLE			    (1)
#define	ZMPUART_INT_MASK		0x3FE00000
