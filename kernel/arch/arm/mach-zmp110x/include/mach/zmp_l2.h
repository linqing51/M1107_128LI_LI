/*
 * linux/arch/arm/mach-anycloud/include/mach/zmp_l2.h
 *
 *
...
/*
 * L2 Control Register List and Bit map definition
...
/*
 * L2 buffer size(buffer 0 to buffer 7), all 512Bytes.
...
/*
 * DMA size in bytes per transfer (Always 64Bytes)
 * L2 DMA transfer follows this definition.
 */
#define DMA_ONE_SHOT_LEN		64

/*
 * L2 Buffer Status Multiply Ratio(64)
...
#define L2_CLOCK_REG			(ZMP_VA_SYSCTRL + 0x1C)
