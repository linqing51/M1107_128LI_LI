/*
 * linux/arch/arm/mach-zmp110x/include/mach/uncompress.h
 *
...
#define CLK_CORE_PLL_CTRL			(ZMP_PA_SYSCTRL + 0x08)
...
#define PPU_PPD1_REG           	REG32(ZMP_PA_SYSCTRL + 0x194) //0x08000194
#define TXD0_PU_BIT             1
#define RXD0_PU_BIT             0
/*********** Shared pin control reigsters ********/
#define SRDPIN_CTRL1_REG     	REG32(ZMP_PA_SYSCTRL + 0x178) //0x08000178
#define UART0_RXD				0
#define UART0_TXD				2

/* Clock control register */
#define CLK_CTRL_REG1			REG32(ZMP_PA_SYSCTRL + 0x1C) //0x0800001C
